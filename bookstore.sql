...
INSERT INTO `about` VALUES (1,'許恬綺','心得'),(2,'黃雅芳','心得'),(3,'陳亮竹','心得'),(4,'李欣樺','下學期負責後端的部分後，才比較清楚前後端的分工應該要怎麼去區分，以及整合的時候要注意哪些細節。我們也嘗試在後台建立瀏覽者點閱分析，可以隨時去這個頁面看數據，藉由知道某類型適合哪個年齡層的人或哪個性別的人，來做出有效且精準的決策。最後，我們這組的組員非常棒，合作很愉快。'),(5,'辜麗慈','這次擔任後端開發的角色，因此code側重的能力較為不同，除了要看懂前端的框架、標籤選擇、切版，還要思考後端怎麼運用簡潔明瞭的邏輯輸出內容。在這個過程中，判斷的依據尤為重要，因此使用DS, SQL, Array去輔助想要抓取的data。儘管每次看到500或是一堆不知所云的錯誤都會想忍不住大叫，但我認為這還是一次很重要的練習。謝謝我的後端戰友們，如果沒有他們我可能會爆肝，謝謝我們的互相扶持～讓痛苦是有意義的'),(6,'陳威宏','秉持著大一從做中學的精神，繼續在網站設計的領域由後端的角度奮戰，\n後端的核心在於實現商業邏輯，果然邏輯這件事情是很難建立關聯的。在自學與不斷收到error:500的錯誤中不斷嘗試與思考究竟要做到什麼地步，\n好像怎麼寫都對又好像怎麼寫都錯，卻又不甘於算了，還是方便就好。非常感謝組員們用盡了耐心彼此交換意見，讓這份專案能夠順利完工。');
...
INSERT INTO `cart` VALUES (2,4,1,355,'N20230606001'),(2,27,2,758,'N20230606001'),(3,4,2,710,'N20230605001'),(3,8,1,252,'N20230605001'),(3,24,1,315,'N20230605001'),(4,4,1,355,'N20230605002'),(4,8,4,1008,'N20230605002');
...
INSERT INTO `click` VALUES (1,0,0,0,0),(2,12,4,2,2),(3,3,1,2,1),(4,45,0,0,0),(5,0,23,0,0),(6,0,0,4,1),(7,0,1,0,0),(8,0,0,4,8),(9,14,5,5,0),(10,0,0,0,9),(11,0,12,6,0),(12,0,0,33,0),(13,6,0,0,4),(14,0,5,0,0),(15,3,0,6,7),(16,1,2,0,6),(17,0,6,11,5),(18,4,8,5,6),(19,0,2,3,7);
...
INSERT INTO `order` VALUES ('N20230605001',3,'2023-06-05','待出貨','辜麗慈','0912345678','桃園市中壢區中北路200號','貨到付款',1277,127,1150),('N20230605002',4,'2023-06-05','待出貨','陳威宏','0912345678','桃園市中壢區中北路200號','貨到付款',1363,136,1227),('N20230606001',2,'2023-06-06','待出貨','李欣樺','0912345678','桃園市中壢區中北路200號','貨到付款',1113,111,1002);
