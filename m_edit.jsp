...
<body>
    <p>產品查詢&更改</p>
    <div class="m_text3">
        <input class="search" type="search" id="search" placeholder="輸入產品ID或產品名">
    ...
    <form action="" method="post">
        <table class="m_shelves">
            ...
            <tr>
                ...
                <td class="m_text">
                    <textarea name="Promotions" rows="6" cols="55"></textarea>
                </td>
            </tr>
            ...
            <tr>
                <td class="m_text" colspan="2">
                    <input class="submit_text" type="submit" class="submit" name="delete" value="刪除">
                    <input class="submit_text" type="submit" class="submit" name="edit" value="確定修改">
                </td>
            </tr>
        </table>
