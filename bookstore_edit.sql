...
INSERT INTO about VALUE ('1', '許恬綺', '我覺得這次的多媒課程讓我獲得了很多收穫尤其是期末專案，
上學期我在後端中過的非常痛苦，寫程式對於我來說真的非常不容易且不快樂，但這是的前端對我來說有趣很多，
雖然還是很多寫不出來，但沒關係因為我有優秀的同學，我覺得能遇到他們是我大二最大的幸運。');
...
INSERT INTO about VALUE ('3', '陳亮竹', '雖然過去已經寫過網頁，但因為過去是用套版，而這一次卻是自己架構再把他寫出來。在製作網頁的過程當中，我也遇到一些困難，但身邊的組員和朋友都有給了一些建議，讓我們這個網站變得更好。這個專案做完之後讓我非常有成就感，也謝謝後端的支持讓我們做出來我們想要的樣子。');
